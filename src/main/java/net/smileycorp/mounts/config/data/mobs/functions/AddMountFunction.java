...
public class AddMountFunction extends SpawnEntityFunction {

    public AddMountFunction(Value<String> value, List<Pair<SpawnFunction, List<Condition>>> functions) {
        super(value, functions);
    }

    protected void applyFunctions(SpawnContext ctx, EntityLiving entity) {
       super.applyFunctions(ctx, entity);
       ctx.getEntity().startRiding(entity);
    }
